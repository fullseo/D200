...
#define CUSTOM_MACHINE_NAME "W0W3D_D200"
...
//p: 51.91 Ki: 5.32 Kd: 126.51
//  #define  DEFAULT_Kp 51.91
//  #define  DEFAULT_Ki 5.32
//  #define  DEFAULT_Kd 126.51
...
//  #define  DEFAULT_bedKd 461.18
 ...
 //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  ...
  #define  DEFAULT_bedKp 681.39
  #define  DEFAULT_bedKi 134.16
  #define  DEFAULT_bedKd 865.20
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    //#define DELTA_CALIBRATION_RADIUS 95.26 // Default 100.8mm
    //#define DELTA_CALIBRATION_RADIUS 104.4 // Default 100.8mm
    #define DELTA_CALIBRATION_RADIUS 81.0 // Default 100.8mm
    // Set the steprate for papertest probing
    #define PROBE_MANUALLY_STEP 0.05
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 90.0 //116.0 // mm

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 250.0 //271.5 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 260.0 // 295.2 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 142.5 // 134.4 //145 //mm  Get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER 1.0 // -15.86//1.00 // Z offset: -below +above  [the nozzle], Anycubic Leveling Module v1:-18.0, v2:-14.9
...
#define INVERT_X_DIR false // DELTA does not invert. For TMC2100 set to false
#define INVERT_Y_DIR false // For TMC2100 set to false
#define INVERT_Z_DIR false // For TMC2100 set to false
